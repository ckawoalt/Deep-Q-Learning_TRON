...
class Tile(Enum):
    ...
    def color(self):
        if self == Tile.EMPTY:
            ...
            return (0, 34, 255)
        elif self == Tile.PLAYER_ONE_slide:
            return (0, 180, 250)
            ...
            return (255, 34, 0)
        elif self == Tile.PLAYER_TWO_slide:
            return (250, 100, 0)
        else:
            return None
...
class Map:
    ...
    def color(self, t, p):
        if t == Tile.EMPTY:
            ...
            return -1
        elif t == Tile.PLAYER_ONE_BODY or t == Tile.PLAYER_ONE_slide:
            return -2 if p == 1 else -3
        elif t == Tile.PLAYER_ONE_HEAD:
            return 10 if p == 1 else -10
        elif t == Tile.PLAYER_TWO_BODY or t == Tile.PLAYER_TWO_slide:
